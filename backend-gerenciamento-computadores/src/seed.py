# Importa o app e o db do seu arquivo principal para usar o mesmo contexto
from main import app, db 
from src.models.computador import ModeloComputador, Gerencia, Patrimonio
...
def populate_database():
    ...
    gerencias_data = [
        ...
        {'id': 22, 'nome': 'SALA 2'}, {'id': 23, 'nome': 'SALA 3'},
        {'id': 24, 'nome': 'SALA 4'}, {'id': 25, 'nome': 'SALA 5'}, {'id': 26, 'nome': 'SALA 6'},
        {'id': 27, 'nome': 'SALA 7'}, {'id': 28, 'nome': 'SALA 8'}, {'id': 29, 'nome': 'SALA 9'},
        {'id': 30, 'nome': 'SALA CHEFE GAB.'}, {'id': 31, 'nome': 'SALA DE REUNIAO'}, {'id': 32, 'nome': 'SALA DO PROC. GERAL'},
        {'id': 33, 'nome': 'SALA SUBPROC. GERAL'}, {'id': 34, 'nome': 'Almoxarifado'}
    ]
    ...
    if Patrimonio.query.first() is None:
        ...
        patrimonios_data = [
            ...
            {'id': 164, 'patrimonio': '10578', 'nome_servidor_responsavel': 'Cristiano Reis', 'modelo_id': 1, 'gerencia_id': 24},
            {'id': 165, 'patrimonio': '10523', 'nome_servidor_responsavel': 'Paulo Grahal', 'modelo_id': 1, 'gerencia_id': 24},
            {'id': 166, 'patrimonio': '10548', 'nome_servidor_responsavel': 'James Henrique', 'modelo_id': 1, 'gerencia_id': 24},
            {'id': 167, 'patrimonio': '10593', 'nome_servidor_responsavel': 'Marcelo Veiga', 'modelo_id': 1, 'gerencia_id': 25},
            {'id': 168, 'patrimonio': '20764', 'nome_servidor_responsavel': 'Bruno Pereira', 'modelo_id': 3, 'gerencia_id': 25},
            {'id': 169, 'patrimonio': '20763', 'nome_servidor_responsavel': 'Rodrigo Rabelo', 'modelo_id': 3, 'gerencia_id': 25},
            {'id': 170, 'patrimonio': '20769', 'nome_servidor_responsavel': 'Ricardo Perez', 'modelo_id': 3, 'gerencia_id': 25},
            {'id': 171, 'patrimonio': '10587', 'nome_servidor_responsavel': 'Rafael Dutra', 'modelo_id': 1, 'gerencia_id': 26},
            {'id': 172, 'patrimonio': '10564', 'nome_servidor_responsavel': 'Ana Cláudia', 'modelo_id': 1, 'gerencia_id': 26},
            {'id': 173, 'patrimonio': '10576', 'nome_servidor_responsavel': 'Vitória Jacob', 'modelo_id': 1, 'gerencia_id': 26},
            {'id': 174, 'patrimonio': '10573', 'nome_servidor_responsavel': 'Heloísa Carvalho', 'modelo_id': 1, 'gerencia_id': 26},
            {'id': 175, 'patrimonio': '10535', 'nome_servidor_responsavel': 'Estação', 'modelo_id': 1, 'gerencia_id': 27},
            {'id': 176, 'patrimonio': '10534', 'nome_servidor_responsavel': 'Fernando Magalhães', 'modelo_id': 1, 'gerencia_id': 27},
            {'id': 177, 'patrimonio': '10530', 'nome_servidor_responsavel': 'Camila Pyramo', 'modelo_id': 1, 'gerencia_id': 27},
            {'id': 178, 'patrimonio': '10568', 'nome_servidor_responsavel': 'Fernando Couto', 'modelo_id': 1, 'gerencia_id': 27},
            {'id': 179, 'patrimonio': '10597', 'nome_servidor_responsavel': 'Delze Laureano', 'modelo_id': 1, 'gerencia_id': 28},
            {'id': 180, 'patrimonio': '10583', 'nome_servidor_responsavel': 'Luiz Fernando', 'modelo_id': 1, 'gerencia_id': 28},
            {'id': 181, 'patrimonio': '97405', 'nome_servidor_responsavel': 'Carlos Roedel', 'modelo_id': 2, 'gerencia_id': 28},
            {'id': 182, 'patrimonio': '18514', 'nome_servidor_responsavel': 'Pedro Victor/Rusvel Beltrame', 'modelo_id': 3, 'gerencia_id': 28},
            {'id': 183, 'patrimonio': '10524', 'nome_servidor_responsavel': 'Jéssica Zanco', 'modelo_id': 1, 'gerencia_id': 29},
            {'id': 184, 'patrimonio': '10620', 'nome_servidor_responsavel': 'Renata Sena', 'modelo_id': 1, 'gerencia_id': 29},
            {'id': 185, 'patrimonio': '10561', 'nome_servidor_responsavel': 'Júlio Cesar', 'modelo_id': 1, 'gerencia_id': 29},
            {'id': 186, 'patrimonio': '10541', 'nome_servidor_responsavel': 'Hercilia Procopio', 'modelo_id': 1, 'gerencia_id': 29},
            {'id': 187, 'patrimonio': '18509', 'nome_servidor_responsavel': 'Felipe', 'modelo_id': 3, 'gerencia_id': 30},
            {'id': 188, 'patrimonio': '94941', 'nome_servidor_responsavel': 'Reunião', 'modelo_id': 2, 'gerencia_id': 31},
            {'id': 189, 'patrimonio': '18535', 'nome_servidor_responsavel': 'Hercules Guerra', 'modelo_id': 3, 'gerencia_id': 32},
            {'id': 190, 'patrimonio': '18533', 'nome_servidor_responsavel': 'Izabela Boaventura', 'modelo_id': 3, 'gerencia_id': 33},
            {'id': 191, 'patrimonio': '10559', 'nome_servidor_responsavel': 'Estação', 'modelo_id': 1, 'gerencia_id': 33},
            {'id': 192, 'patrimonio': '94939', 'nome_servidor_responsavel': 'nan', 'modelo_id': 2, 'gerencia_id': 34},
            {'id': 193, 'patrimonio': '10591', 'nome_servidor_responsavel': 'nan', 'modelo_id': 1, 'gerencia_id': 34},
            {'id': 194, 'patrimonio': '10619', 'nome_servidor_responsavel': 'nan', 'modelo_id': 1, 'gerencia_id': 34},
            {'id': 195, 'patrimonio': '97420', 'nome_servidor_responsavel': 'Eduardo Magalhães', 'modelo_id': 2, 'gerencia_id': 34},
            {'id': 196, 'patrimonio': '97412', 'nome_servidor_responsavel': 'Estação', 'modelo_id': 2, 'gerencia_id': 34},
            {'id': 197, 'patrimonio': '10566', 'nome_servidor_responsavel': 'Estação', 'modelo_id': 1, 'gerencia_id': 34},
            {'id': 198, 'patrimonio': '10560', 'nome_servidor_responsavel': 'Estação', 'modelo_id': 1, 'gerencia_id': 34},
            {'id': 199, 'patrimonio': '10588', 'nome_servidor_responsavel': 'Estação', 'modelo_id': 1, 'gerencia_id': 34},
            {'id': 200, 'patrimonio': '94944', 'nome_servidor_responsavel': 'Estação', 'modelo_id': 2, 'gerencia_id': 34},
            {'id': 201, 'patrimonio': '97400', 'nome_servidor_responsavel': 'Estação', 'modelo_id': 2, 'gerencia_id': 34},
            {'id': 202, 'patrimonio': '97436', 'nome_servidor_responsavel': 'Estação', 'modelo_id': 2, 'gerencia_id': 34},
            {'id': 203, 'patrimonio': '97583', 'nome_servidor_responsavel': 'Estação', 'modelo_id': 2, 'gerencia_id': 34},
            {'id': 204, 'patrimonio': '94916', 'nome_servidor_responsavel': 'Estação', 'modelo_id': 2, 'gerencia_id': 34},
            {'id': 205, 'patrimonio': '94924', 'nome_servidor_responsavel': 'Estação', 'modelo_id': 2, 'gerencia_id': 34},
        ]
        ...
        db.session.commit()
        print("Patrimônios inseridos.")

if __name__ == '__main__':
    # Usamos o app_context para ter acesso ao banco de dados
